...
import static Modelo.HamburguesaTobby.txtCantidad;
...
public class TexasBurger extends javax.swing.JFrame {
    ...
    void listarProducto() {
        ...
        List<Producto> lista = dao.listarProducto5();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TexasBurger.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TexasBurger().setVisible(true);
            }
        });
    }
