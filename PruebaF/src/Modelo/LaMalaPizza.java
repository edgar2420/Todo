...
public class LaMalaPizza extends javax.swing.JFrame {
    ...
    void listarProducto() {
        ...
        List<Producto> lista = dao.listarProducto7();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LaMalaPizza.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LaMalaPizza().setVisible(true);
            }
        });
    }
