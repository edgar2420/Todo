...
import static Modelo.PollosChuy.txtCantidad;
...
public class HamburguesaTobby extends javax.swing.JFrame {
    ...
    void listarProducto() {
        ...
        List<Producto> lista = dao.listarProducto6();
    ...
    private void initComponents() {
        ...
        if (TablaComida.getColumnModel().getColumnCount() > 0) {
            TablaComida.getColumnModel().getColumn(0).setMinWidth(25);
            TablaComida.getColumnModel().getColumn(0).setPreferredWidth(25);
            TablaComida.getColumnModel().getColumn(0).setMaxWidth(25);
            TablaComida.getColumnModel().getColumn(2).setMinWidth(60);
            TablaComida.getColumnModel().getColumn(2).setPreferredWidth(60);
            TablaComida.getColumnModel().getColumn(2).setMaxWidth(60);
            TablaComida.getColumnModel().getColumn(4).setMinWidth(100);
            TablaComida.getColumnModel().getColumn(4).setPreferredWidth(100);
            TablaComida.getColumnModel().getColumn(4).setMaxWidth(100);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HamburguesaTobby.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HamburguesaTobby().setVisible(true);
            }
        });
    }
