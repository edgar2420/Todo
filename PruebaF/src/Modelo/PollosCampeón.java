...
public class PollosCampeón extends javax.swing.JFrame {
    ...
    void listarProducto() {
        ...
        List<Producto> lista = dao.listarProducto3();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PollosCampeón.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PollosCampeón().setVisible(true);
            }
        });
    }
