...
public class PollosSolar extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        //DefaultTableModel tabladet = (DefaultTableModel)Carrito.TablaDetalle.getModel();
modelo = (DefaultTableModel) TablaDetalle.getModel();
        //Boleta es mi clase, tbdetbol es el nombre de mi jtable recuerda hacerlo publico
        ...
        dato[1] = txtRestaurante.getText();
        dato[2] = txtPrecio.getText();
        dato[3] = txtNombre.getText();
        dato[4] = txtTipo.getText();
        dato[5] = txtCantidad.getText();*/
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PollosSolar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PollosSolar().setVisible(true);
            }
        });
    }
    ...
    public static javax.swing.JTextField txtRestaurante;
